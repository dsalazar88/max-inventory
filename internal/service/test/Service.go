...
import (
	context "context"
	models "courses/golang/inventory-project/internal/models"
...
func (_m *Service) AddProduct(ctx context.Context, product models.Product, email string) error {
...
func (_m *Service) GetProduct(ctx context.Context, id int64) (*models.Product, error) {
...
func (_m *Service) GetProducts(ctx context.Context) ([]models.Product, error) {
	ret := _m.Called(ctx)
...
func (_m *Service) RemoveUserRole(ctx context.Context, userId int64, roleId int64) error {
...
func (_m *Service) SaveUserRole(ctx context.Context, userId int64, roleId int64) error {
	ret := _m.Called(ctx, userId, roleId)
